...
width:650px;">
<!-- 미리보기 이미지 -->
<img id="blah" src="../image/noimage.jpg" alt="your image" />
	<form action="smartaction.jsp" method="post" enctype="multipart/form-data">
		<table class="table table-bordered">
		<caption align="top"><h5><b><i class="bi bi-pencil" style="color:blue;"></i>&nbsp;스마트 글쓰기</b></h5></caption>
			<tr>
			...
			<tr>
				...
				<td><input type="file" class="form-control form-control-sm" name="mainphoto" required="required" onchange="readURL(this);"></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="center" colspan="2">
					...
					<button type="button" class="btn btn-outline-danger"
					style="width:120px;" onclick="location.href='smartlist.jsp'">목록으로</button>
